...
<div id="main">
    ...
    <div class="container">
        ...
        <div id="post-8" class="post-8 page type-page status-publish hentry">
            ...
            <form class="woocommerce-form woocommerce-form-login login" method="post" action="{{ route('register') }}">
                ...
                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    ...
                    <label for="username">Nom complet&nbsp;<span class="required">*</span></label>

                    <input id="name" type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="name" value="{{ $name ?? old('name') }}" required autocomplete="name" autofocus>
                ...
                <p class="form-row">
                    ...
                    <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce" value="47eb52a8c4"><input type="hidden" name="_wp_http_referer" value="/my-account/">              <button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="Log in">S'inscrire</button>
                 ...
                 <p class="woocommerce-LostPassword lost_password">
                    ...
                    <a href="{{ route('login') }}">déjà client?</a> &nbsp;
