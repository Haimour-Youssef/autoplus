...
@section('content')
<div class="main-content" data-object="actualites">
	
	<!-- end: SPANEL CONFIGURATION MODAL FORM -->
	<div class="container">
		
		@include('back.layouts.title', ['menu' => 'Paramétrages','objet' => 'Actualite'])
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-2 ">
								...
								<a class="btn btn-green" href="{{ route('actualites.create') }}">
						...
						<div class="row">
							<div class="col-sm-12">@include('back.actualites.partials.table')</div>
						</div>
