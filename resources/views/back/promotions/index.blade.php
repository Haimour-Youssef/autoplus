...
@section('content')
<div class="main-content" data-object="promotions">
	
	<!-- end: SPANEL CONFIGURATION MODAL FORM -->
	<div class="container">
		
		@include('back.layouts.title', ['menu' => 'Paramétrages','objet' => 'Promotion'])
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-2 ">
								...
								<a class="btn btn-green" href="{{ route('promotions.create') }}">
						...
						<div class="row">
							<div class="col-sm-12">@include('back.promotions.partials.table')</div>
						</div>
