  ...
  <div class="tab-content">
    <div class="tab-pane in active" id="panel_tab3_example1">
      ...
      <div class="form-group">
        ...
        value="{{ old('libelle', $commentaire->libelle ?? null) }}"/>
      ...
      <div class="form-group">
        ...
        <textarea name="description" class="form-control" cols="10" rows="10">{{ old('description', $commentaire->description ?? null) }}</textarea>
    ...
    <div class="tab-pane" id="panel_tab3_example2">
      ...
      <div class="form-group">
        ...
        <select name="marque_id" class="form-control mb-3">
          ...
          <option value="{{ $data->id }}" 
           ...
           @if ( isset($commentaire)) {{ $commentaire->marque_id == $data->id ? 'selected' : '' }} @endif
       ...
       <div class="form-group">
        ...
        <select name="famille_id" class="form-control mb-3">
          ...
          <option value="{{ $data->id }}" 
           ...
           @if ( isset($commentaire)) {{ $commentaire->famille_id == $data->id ? 'selected' : '' }} @endif
       ...
       <div class="form-group">
        ...
        <select name="fournisseur_id" class="form-control mb-3">
          ...
          <option value="{{ $data->id }}" 
           ...
           @if ( isset($commentaire)) {{ $commentaire->fournisseur_id == $data->id ? 'selected' : '' }} @endif
        ...
        value="{{ old('prix_ttc', $commentaire->prix_ttc ?? null) }}"/>
      ...
      <div class="form-group">
        ...
        value="{{ old('prix_reduis', $commentaire->prix_reduis ?? null) }}"/>
      ...
      <div class="form-group">
        ...
        value="{{ old('stock', $commentaire->stock ?? null) }}"/>
     ...
     <div class="tab-pane" id="panel_tab3_example4">
      ...
      <div class="form-group">
        ...
        <img width="300"  src="{{ $commentaire->image->url('thumbails-450') }}">
        @else
