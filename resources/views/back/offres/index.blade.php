...
@section('content')
<div class="main-content" data-object="offres">
	
	<!-- end: SPANEL CONFIGURATION MODAL FORM -->
	<div class="container">
		
		@include('back.layouts.title', ['menu' => 'Paramétrages','objet' => 'Offre'])
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-2 ">
								...
								<a class="btn btn-green" href="{{ route('offres.create') }}">
						...
						<div class="row">
							<div class="col-sm-12">@include('back.offres.partials.table')</div>
						</div>
