...
<div class="form-group col-12 col-md-6">
    ...
    value="{{ old('url', $seo->url ?? null) }}"/>
</div>

<div class="form-group col-12 col-md-6">
    <label>Name</label>
    <input type="text" name="name" class="form-control"
    value="{{ old('name', $seo->name ?? null) }}"/>
</div>

<div class="form-group">
    <label>Property</label>
    <input type="text" name="property" class="form-control"
    value="{{ old('property', $seo->property ?? null) }}"/>
</div>

<div class="form-group col-12 col-md-6">
    <label>Rel</label>
    <input type="text" name="rel" class="form-control"
    value="{{ old('rel', $seo->rel ?? null) }}"/>
</div>

<div class="form-group col-12 col-md-6">
    <label>Href</label>
    <input type="text" name="href" class="form-control"
    value="{{ old('href', $seo->href ?? null) }}"/>
</div>
