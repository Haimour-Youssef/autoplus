...
@section('content')
<div class="main-content" data-object="Référencement">
	
	<!-- end: SPANEL CONFIGURATION MODAL FORM -->
	<div class="container">
		
		@include('back.layouts.title', ['menu' => 'Paramétrages','objet' => 'Référencement'])
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-2 ">
								...
								<a class="btn btn-green" href="{{ route('referencements.create') }}">
						...
						<div class="row">
							<div class="col-sm-12">@include('back.referencements.partials.table')</div>
						</div>
