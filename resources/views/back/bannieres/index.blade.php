...
@section('content')
<div class="main-content" data-object="bannieres">
	
	<!-- end: SPANEL CONFIGURATION MODAL FORM -->
	<div class="container">
		
		@include('back.layouts.title', ['menu' => 'Paramétrages','objet' => 'Banniére'])
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-2 ">
								...
								<a class="btn btn-green" href="{{ route('bannieres.create') }}">
						...
						<div class="row">
							<div class="col-sm-12">@include('back.bannieres.partials.table')</div>
						</div>
