...
@section('content')
<div class="main-content" data-object="categories">
	
	<!-- end: SPANEL CONFIGURATION MODAL FORM -->
	<div class="container">
		
		@include('back.layouts.title', ['menu' => 'Paramétrages','objet' => 'Categorie'])
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-2 ">
								...
								<a class="btn btn-green" href="{{ route('categories.create') }}">
						...
						<div class="row">
							<div class="col-sm-12">@include('back.categories.partials.table')</div>
						</div>
