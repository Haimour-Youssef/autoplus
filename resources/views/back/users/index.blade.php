...
<link rel="stylesheet" href="{{ asset('assets/plugins/DataTables/user/css/DT_bootstrap.css') }}" />

<!-- end: CSS REQUIRED FOR THIS PAGE ONLY -->

<link href="{{ asset('assets/components/select2/dist/css/select2.min.css?v=12') }}" rel="stylesheet" />
    <link href="{{ asset('assets/components/datatables/media/css/dataTables.bootstrap.min.css?v=12') }}" rel="stylesheet" />
    <link href="{{ asset('assets/components/datatables/media/css/jquery.dataTables.min.css?v=12') }}" rel="stylesheet" />
    <link href="{{ asset('assets/components/datatables.net-buttons-dt/css/buttons.dataTables.min.css?v=12') }}" rel="stylesheet" />
...
@section('content')
<div class="main-content" data-object="users">
	
	<!-- end: SPANEL CONFIGURATION MODAL FORM -->
	<div class="container">
		
		@include('back.layouts.title', ['menu' => 'Paramétrages','objet' => 'Candidat'])
			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-sm-12">@include('back.users.partials.table')</div>
						</div>
...
<script src="{{ asset('assets/components/bootbox.js/bootbox.js?v=12') }}"></script>
    <script src="{{ asset('assets/components/jquery-mockjax/dist/jquery.mockjax.min.js?v=12') }}"></script>
    <script src="{{ asset('assets/components/select2/dist/js/select2.min.js?v=12') }}"></script>
    <script src="{{ asset('assets/components/datatables/media/js/jquery.dataTables.min.js?v=12') }}"></script>
    <script src="{{ asset('assets/components/datatables.net-buttons/js/dataTables.buttons.min.js?v=12') }}"></script>
    <script src="{{ asset('assets/components/datatables.net-buttons/js/buttons.flash.min.js?v=12') }}"></script>
    <script src="{{ asset('assets/components/jszip/dist/jszip.min.js?v=12') }}"></script>
    <script src="{{ asset('assets/components/pdfmake/build/pdfmake.min.js?v=12') }}"></script>
    <script src="{{ asset('assets/components/pdfmake/build/vfs_fonts.js?v=12') }}"></script>
    <script src="{{ asset('assets/components/datatables.net-buttons/js/buttons.html5.min.js?v=12') }}"></script>
    <script src="{{ asset('assets/components/datatables.net-buttons/js/buttons.print.min.js?v=12') }}"></script>
    <script src="{{ asset('assets/js/min/table-export.min.js?v=12') }}"></script>
