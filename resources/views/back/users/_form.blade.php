...
<div class="form-group">
    <label>Content</label>
    <textarea name="content" class="ckeditor form-control" cols="10" rows="10">{{ old('content', $user->content ?? null) }}</textarea>
</div>
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="input-group">
        <input value="{{ old('date_user', $user->date_user ?? null) }}"  name="date_user" type="text" data-date-format="yyyy-mm-dd" data-date-viewmode="years" class="form-control date-picker">
...
<div class="form-group">
    ...
    @if($user ?? '')
    <br />
    <img src='{{ $user->image ? $user->image->url("thumbails-450") : "" }}' width="200">
    @endif
