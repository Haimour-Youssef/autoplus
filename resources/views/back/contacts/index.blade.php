...
@section('content')
<div class="main-content" data-object="contacts">
	
	<!-- end: SPANEL CONFIGURATION MODAL FORM -->
	<div class="container">
		
		@include('back.layouts.title', ['menu' => 'Paramétrages','objet' => 'Contact'])
			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-sm-12">@include('back.contacts.partials.table')</div>
						</div>
