...
<link rel="stylesheet" href="{{ asset('assets/plugins/DataTables/contact/css/DT_bootstrap.css') }}" />
...
<div class="form-group">
    ...
    value="{{ old('title', $contact->title ?? null) }}"/>
</div>

<div class="form-group">
    <label>Content</label>
    <textarea name="content" class="ckeditor form-control" cols="10" rows="10">{{ old('content', $contact->content ?? null) }}</textarea>
</div>


<div class="form-group">
    <label for="partenaire">Catégorie</label>
 ...
 <div class="form-group">
    ...
    <div class="input-group">
        <input value="{{ old('date_contact', $contact->date_contact ?? null) }}"  name="date_contact" type="text" data-date-format="yyyy-mm-dd" data-date-viewmode="years" class="form-control date-picker">
...
<div class="form-group">
    ...
    @if($contact ?? '')
    <br />
    <img src='{{ $contact->image->url("thumbails-450") }}' width="200">
    @endif
