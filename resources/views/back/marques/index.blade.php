...
<div class="main-content" data-object="marques">

	<!-- end: SPANEL CONFIGURATION MODAL FORM -->
	<div class="container">
		<!-- start: PAGE HEADER -->
		@include('back.layouts.title', ['menu' => 'Paramétrage','objet' => 'Marque'])
		<!-- end: PAGE HEADER -->
		<!-- start: PAGE CONTENT -->
			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<i class="fa fa-external-link-square"></i><span class="marques-counter">{{ $marques->count() }}</span> Trouvé(s)
					...
					<div class="panel-body">
						...
						<div class="table-responsive">
							...
							<table class="table table-striped table-hover" data-object="marques" id="sample_2">
								<thead>
									<tr>
										<th>Libelle</th>
										<th>Produits</th>
...
<script src="{{ asset('assets/js/parametrages/marques.js') }}"></script>
