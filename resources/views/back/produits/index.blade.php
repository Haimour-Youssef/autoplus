...
@section('content')
<div class="main-content" data-object="produits">
	
	<!-- end: SPANEL CONFIGURATION MODAL FORM -->
	<div class="container">
		
		@include('back.layouts.title', ['menu' => 'Paramétrages','objet' => 'Produit'])
		
		@include('back.produits.partials.recherche')
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
							...
							<div class="col-md-4 ">
								...
								<div class="btn-group btn-selection btn-block  my-3" >
									...
									<ul class="dropdown-menu  btn-block" role="menu">
										...
										<form method="POST" id="form-verifie-select" class="fm-inline"	action="{{ route('produitDestroySelect') }}">
											@method('DELETE')
											@csrf
						...
						<div class="col-md-2 col-md-offset-6">
							...
							<a class="demo btn btn-bricky btn-block  my-3" data-toggle="modal" href="{{ route('produits.create') }}">
					...
					<div class="row">
						<div class="col-sm-12">@include('back.produits.partials.table')</div>
					</div>


					@include('back.produits.partials.pagination')
