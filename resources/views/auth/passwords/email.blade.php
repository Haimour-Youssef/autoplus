            ...
            <div class="row  justify-content-md-center">
                ...
                <div class=" col-md-6 padding-four-lr padding-six-half-tb lg-padding-five-tb lg-padding-six-lr md-padding-six-all sm-padding-50px-tb sm-padding-15px-lr wow fadeInTop">
                    ...
                    <div class=" tab-style2">
                        ...
                        <h5 class="alt-font text-extra-dark-gray text-center text-lg-left margin-eight-bottom md-margin-40px-bottom sm-margin-30px-bottom font-weight-600"><span class="font-weight-300 d-block sm-margin-15px-bottom">Espace Candidat</span> Mot de passe oublié</h5>
                                ...
                                <div class="col-12">
                                    ...
                                    <div>
                                        ...
                                        <form method="POST" action="{{ route('password.email') }}">
                                            ...
                                            <input id="email" type="email" placeholder="Email *" class=" @error('email') is-invalid @enderror input-bg" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>



                                            <button type="submit" class="btn btn-dark-gray btn-small float-right text-extra-small btn-rounded margin-5px-top">
                                                Envoyer lien <i class="fa fa-arrow-circle-right"></i>
                                            </button>
