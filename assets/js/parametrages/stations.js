...
var TableData = function () {
	...
	var runEditableTable = function(){
		...
		function editRow(oTable, nRow) {
			...
			jqTds[2].innerHTML = '<input type="text" class="form-control" name="email" value="' + aData[2] + '">';
			jqTds[3].innerHTML = '<input type="text" class="form-control" name="tel" value="' + aData[3] + '">';
			jqTds[4].innerHTML = '<input type="text" class="form-control" name="fax" value="' + aData[4] + '">';
			jqTds[5].innerHTML = '<input type="text" class="form-control" name="adresse" value="' + aData[5] + '">';
			jqTds[6].innerHTML = '<input type="text" class="form-control" name="patente" value="' + aData[6] + '">';
			jqTds[7].innerHTML = '<input type="text" class="form-control" name="nbr_controle" value="' + aData[7] + '">';
			
			jqTds[8].innerHTML = '<input type="text" class=" no-display" value="' + aData[8] + '">';
		...
		function saveRow(oTable, nRow) {
			...
			oTable.fnUpdate('<a class="edit-row" href="">Edit</a>', nRow, 10, false);

			if ((jqInputs[1].value) + (jqInputs[2].value) == 0)
			oTable.fnUpdate('<a class="delete-row" href="">Delete</a>', nRow, 11, false);
			else oTable.fnUpdate('<a></a>', nRow, 11, false);
			...
			$.ajax({
				...
				success : function(status) {
					...
					if (status.type == "add") {
						...
						$('#sample_2 tbody tr:not([data-id-' + $('#sample_2').attr('data-foreign') + ']').attr('data-id-' + $('#sample_2').attr('data-foreign'),status.data['model']);
					}
					else{
						$('#sample_2 tbody tr[data-id=' + status.data['id'] + ']').attr('data-id-' + $('#sample_2').attr('data-foreign'),status.data['model']);
					}
