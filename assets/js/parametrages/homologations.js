...
var TableData = function () {
	...
	var runEditableTable = function(){
		...
		function editRow(oTable, nRow) {
			...
			jqTds[3].innerHTML = '<input type="text" class="form-control" name="import" value="' + aData[3] + '">';
			jqTds[4].innerHTML = '<input type="text" class="form-control" name="nbr_chfr" value="' + aData[4] + '">';
			jqTds[5].innerHTML = '<input type="text" class="form-control" name="approbation" value="' + aData[5] + '">';
			jqTds[6].innerHTML = '<input type="text" class="form-control" name="support" value="' + aData[6] + '">';
			jqTds[7].innerHTML = '<input type="text" class="form-control" name="info" value="' + aData[7] + '">';
		...
		function saveRow(oTable, nRow) {
			...
			if ((jqInputs[7].value + jqInputs[7].value) == 0)
