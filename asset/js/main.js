...
/* ===================================
 ...
 $(document).ready(function () {
  ...
  $('.btn-details-promotion ').on('click', function () {
     $('#modal-promotion-title').text($(this).siblings( ".promotion-title" ).text());
     $('#modal-promotion-content').html($(this).siblings( ".promotion-content" ).html());
     $('#modal-promotion-img').attr('src',$(this).attr( "data-image-promotion" ));
  ...
  $('.btn-tab1-suivant').on('click', function (e) {
    e.preventDefault();
    $('a[href="#tab_sec2"]').trigger('click');
  });

   $('.btn-tab2-suivant').on('click', function (e) {
    e.preventDefault();
    $('a[href="#tab_sec3"]').trigger('click');
  });


      $('.btn-tab3-suivant').on('click', function (e) {
    e.preventDefault();
    $('a[href="#tab_sec4"]').trigger('click');
  });
  ...
  "use strict";
    ...
    /* ===================================
     ...
     var swiperSixSlides = new Swiper('.swiper-six-slides', {
        ...
        preventClicks: false,
        pagination: {
            el: '.swiper-pagination-six-slides',
            clickable: true
        },
        autoplay:true,
        keyboard: {
    ...
    var swiperMultyRow = new Swiper('.swiper-multy-row-container-categories', {
        allowTouchMove: true,
        slidesPerView: 6,
        spaceBetween: 15,
        pagination: {
    ...
    var swiperMultyRow = new Swiper('.swiper-multy-row-container-valeurs', {
        allowTouchMove: true,
        slidesPerView: 4,
        spaceBetween: 15,
        pagination: {
    ...
    $(window).resize(function () {
        ...
        setTimeout(function () {
            ...
            if ($('.swiper-multy-row-container-categories').length > 0 && swiperMultyRow)
            {
                swiperMultyRow.update();
            }


            if ($('.swiper-multy-row-container-valeurs').length > 0 && swiperMultyRow)
            {
                swiperMultyRow.update();
            }
...
//function preload_(){ clearInterval(intervalId2);
    $('.preload').fadeOut(500);
    $('.categorie-figure').first().trigger('click');
//$('.preload').slideUp(2000);
//$('body').attr('style','overflow:auto;');
//}

//intervalId2 = setInterval(preload_,1000); 
    ...
    $('#contact-us-button-2').on("click", function () {
        ...
        var urli = $('#contact-us-button-2').attr('data-routing');
        if (error) {
            $('#contact-form-2').attr("style",'opacity:.2;cursor:wait');
            $.ajaxSetup({
                headers: {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#contact-form-2').removeAttr("style");
                    $("#success-contact-form-2").html("<b>Envoyأ©!</b><p> Votre message est envoyأ© avec succأ©es</p>");
...
$('.lien-pro-anim').click(function(e){

    e.preventDefault();
    e.stopPropagation();

    $('.cat-det-title').text($(this).attr('data-title'));
    $('.cat-det-description').html($(this).attr('data-description'));
    $('.cat-det-img').html($(this).attr('data-img'));
    $('.cat-det-icon').attr('src',($(this).attr('data-ico')));

   $('.popup-with-move-anim').trigger('click');
 });


 $('.categorie-figure').click(function(){

   //$(".preload").show();
   $(".categorie-flech").hide();
   $(".ajax-div").hide();

   $(".categorie-flech[data-id=" + $(this).attr('data-id') + "]").slideToggle();
   $(".ajax-div[data-id-categorie=" + $(this).attr('data-id') + "]").slideToggle();
  //$('.preload').hide('fast');
});
